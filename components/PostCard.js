...
import { AlertDialogDemo } from "./Dialogbtn";
    ...
    <Card>
                ...
                <div className="relative z-10">
                  {dropdownOpen && (
                    ...
                    <a href="" className="flex gap-3 py-2 my-2 hover:bg-socialBlue hover:text-white -mx-4 px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300">
                      ...
                      <AlertDialogDemo id={id} user={myProfile?.id}>
                        <span className="flex cursor-pointer gap-3 py-2 my-2 hover:bg-socialBlue hover:text-white -mx-4 px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <Link href={`/post/${id}`}>
        <div className="flex gap-2 flex-col">
          <p className="my-3 text-sm line-clamp-3 flex flex-wrap">{content}</p>
          {photos?.length > 0 && (
            <div className="flex gap-3  justify-center items-center">
              {photos.map(photo => (
                <div key={photo} className="flex aspect-video w-full max-h-[240px] justify-center items-center  overflow-hidden">
                  <LazyLoadImage effect="blur" placeholder={<ShimmerThumbnail rounded={true} />} src={photo} alt="photoPost" className="rounded-sm aspect-square object-contain" />
