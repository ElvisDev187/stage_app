...
function Page() {
    ...
    const {mutate , isLoading} = useMutation({
        mutationFn: async({name, email, pass,})=>{
  ...
  return (
    ...
    <div className='px-40 min-h-screen bg-gray-100 flex justify-start items-center flex-col '>
            <UserCircle2 className='h-20 w-20 my-5 text-zinc-600'  absoluteStrokeWidth={true}/>
          <h1 className=' font-semibold text-2xl md:text-3xl text-zinc-400 mt-8'>Add User</h1>
          ...
          <Card>
            <div className="flex flex-col gap-3 w-full">
              <input
                ...
                value={Confirm}
                className='bg-white-500 border  shadow-sm border-gray-300 px-2 py-4ocus:outline-none  rounded-sm text-md text-gray-700 mt-3 mb-0'
                type="password"
