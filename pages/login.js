        ...
        <div className="max-w-xs mx-auto grow -mt-24">
          ...
          <Card noPadding={true}>
            <div className="rounded-md">
              ...
              <button onClick={loginWithGithub} className="w-full flex gap-4 items-center justify-center p-4 border-b border-b-gray-100 hover:bg-socialBlue hover:text-white hover:border-b-socialBlue hover:rounded-md hover:shadow-md hover:shadow-gray-300 transition-all hover:scale-110">
